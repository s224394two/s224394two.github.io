...
show(p)
```
**Figure 1:** Times series plot which shows the distribution of the different shapes and sightings, but also highlights some important dates in regards to media releases. There has been a rather large increase over the year. In particular after the realase of "independence day" and the the show x-files.
